...
general:createYesNoButton {
    label = "Show the information only when equipping a security tool?",
...
general:createDropdown {
    label = "Do you want trapped objects to show enchantment-like visual effect?",
    description = "Shows a glowing visual effect on the trapped object",
